...
CONFIG_PATH = "dataset_config_small.json"
...
ttbar_path = config["Top_bqq"]["path"]
...
plt.tight_layout()
print(f"Saving models/{MODEL_NAME}/sanity_feat_mcmc.png")
plt.savefig(f"models/{MODEL_NAME}/sanity_feat_mcmc.png")
...
plt.tight_layout()
print(f"Saving models/{MODEL_NAME}/sanity_mse.png")
plt.savefig(f"models/{MODEL_NAME}/sanity_mse.png")